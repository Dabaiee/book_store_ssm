...
INSERT INTO `book` VALUES ('1', '罗伯特议事规则', '/upload/1.jpg', '40.9', '罗伯特家族在其生前全面增修版基础上，倾力修订改进的权威、详尽的议学经典！根据2000年由美国Perseus出版的官方版本翻译而成，原版总销量已逾500万册。《央视新闻周刊—岩松说》重磅推荐！', '罗伯特', '格致出版社', '2008-05-01', '0', '0', '0', '2');
...
INSERT INTO `book` VALUES ('28', '恰到好处的幸福', '/upload/28.jpg', '19.7', '恰到好处，是一种哲学和艺术的结晶体。它代表的豁达和淡然，是幸福门前的长廊。轻轻走过它，你就可以拍打幸福的门环。佛家有一句话，叫“无挂碍物者无恐怖”，不妨借用来，少需要物者少烦恼。因为必需少，所以受限轻。人就获得了更快的行走，更高的飞翔。本书把“幸福”作为一种正面的人生价值提出。教你如何构建合理期望，在欲望和现实中找到平衡，收获丰硕愉悦的幸福人生。', '毕淑敏', '湖南文艺出版社', '2014-02-01', '1', '0', '1', '1');
INSERT INTO `book` VALUES ('29', '你是人间四月天', '/upload/29.jpg', '14', '《你是人间四月天》收录了林徽因几乎所有的诗歌、散文、小说。包括诗歌《谁爱这不息的变幻》《你是人间的四月天》《激昂》，散文《悼志摩》《一片阳光》，小说《九十九度中》《模影零篇》等脍炙人口的名篇，内容含量大且丰富，一本书即可了解全部的林徽因。', '林徽因', '北京联合出版公司', '2014-12-01', '0', '0', '1', '1');
INSERT INTO `book` VALUES ('30', '鲁迅全集', '/upload/30.jpg', '199', '《全集》由蔡元培任主席的鲁迅先生纪念委员会负责编校，编辑委员有蔡元培、马裕藻、沈兼士、茅盾、周作人诸先生。《全集》总目以鲁迅亲定的著述目录为基础，增加了译作部分，并力求各册字数大致相当。全书大致分创作、古籍校辑、译作三大部分。各部分内容按时间先后排序。全书总计六百余万字，共分二十卷。于1938年6月正式出版并发行', '鲁迅 ', '北京日报出版社（原同心出版社）', '2014-05-01', '0', '0', '1', '1');
...
INSERT INTO `book` VALUES ('36', '中国文脉', '/upload/36.jpg', '22.8', '本书核心篇目《中国文脉》《笔墨历史》，酣畅淋漓地揭示了三千年中国文学的精神主脉，以及作为文脉载体的三千年中国书法史，为余秋雨教授全新作品，此前从未发表过。在这两个核心篇目之后，是对每个时代文脉的精细论述，通过对23个中国**文人的生命历程及其作品的品读，深度解析了中国人的精神脉络，流露出对中国文坛长期以来文脉衰弱的隐忧与关怀，组成了一部罕见的《中国文化人格史》和《审美精神流变史》。', '余秋雨', '长江文艺出版社', '2012-11-01', '0', '0', '0', '1');
INSERT INTO `book` VALUES ('37', '觉醒的力量', '/upload/37.jpg', '22.8', '觉醒是一种巨大的内在力量，拥有了这个力量，一切外来的负面力量都不能真正把你打败。面对天灾人祸，世风的不正，人心的不善，落在你头上的不义，你诚然仍会痛苦，但是，你一定能够**限度地保持内心的平静，因为你知道，没有什么能夺走你的内在的珍宝，使你的人生失去方向和意义。', '周国平', '广西师范大学出版社', '2015-05-01', '0', '0', '0', '1');
...
INSERT INTO `book` VALUES ('40', '傅雷家书', '/upload/40.jpg', '34.8', '本书以最小最精之篇幅反映《傅雷家书》全貌，再现傅氏兄弟成长的家教背景，全面展示傅雷家风。所选编内容，情节完整，背景清晰，人物鲜明，好看感人，完全迥别于市面上寻章摘句的其他选编本。书中楼适夷初版代序、金圣华中译24封英法文信和傅聪家信9封为独家版权，2017年不随傅雷著作权进入公版，其他任何家书选本不得收录。', '朱梅馥', '江苏凤凰文艺出版社', '2015-05-01', '0', '0', '0', '1');
